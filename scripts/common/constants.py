...
if not sum([IS_CHINA,
 ...
 IS_SINGAPORE]) <= 1:
    ...
    class ARENA_BONUS_TYPE_CAPS:
        ...
        SORTIE = RESULTS | DAMAGE_VEHICLE | CREDITS | XP | RANSOM | DOSSIER_TOTAL | DOSSIER_KILL_LIST | DOSSIER_SORTIE | DOSSIER_MAXSORTIE | DOSSIER_ACHIEVEMENTS_SORTIE | FORT_RESOURCE | INFLUENCE_POINTS | QUESTS | TKILL_RATING
        ...
        RATED_CYBERSPORT = RESULTS | DOSSIER_RATED7X7 | DOSSIER_MAXRATED7X7 | CYBERSPORT_RATING | DOSSIER_CLUB | DOSSIER_ACHIEVEMENTS_RATED7X7
